...
<template>
  ...
  <base-input label="DateReceived" type="text" placeholder="Enter DateReceived" v-model="notificationToAdd.dateReceived"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'dateReceived',
          visible: true,
          scopedSlots: { customRender: 'dateReceived' },
          sorter: true
          //sorter: (a, b) => a.dateReceived - b.dateReceived,
